...
good_will_hunting = media.Movie("Good Will Hunting",
                                "An unrecognized genius confronts his " +
                                "past and future.",
...
django_unchained = media.Movie("Django Unchained",
                               "A slave and eccentric bounty hunter's " +
                               "journey to rescue the slave's wife from " +
                               "a vicious plantation owner.",
...
sing_street = media.Movie("Sing Street",
                          "A high school boy starts a band to " +
                          "impress a girl in 1980s Ireland.",
...
the_usual_suspects = media.Movie("The Usual Suspects",
                                 "Five conmen are brought together " +
                                 "for one last job.",
...
wreck_it_ralph = media.Movie("Wreck It Ralph",
                             "An arcade villain rebels against his " +
                             "role and embraces his dream of being a hero.",
...
my_cousin_vinny = media.Movie("My Cousin Vinny",
                              "A newly minter lawyer defends his nephew " +
                              "and friend on murder charges in rural Alabama.",
...
movies = [good_will_hunting, django_unchained,
          sing_street, the_usual_suspects, wreck_it_ralph, my_cousin_vinny]
